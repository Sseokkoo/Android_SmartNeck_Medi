...
import com.smartneck.fit.Fit.CustomerSupport.Item.Fit_Customer1To1Item;
import com.smartneck.fit.R;

import java.util.ArrayList;

public class Fit_Customer1To1Adapter extends BaseAdapter {
    ArrayList<Fit_Customer1To1Item> customer1To1Items;
    LayoutInflater inflater;
    Holder holder;
    public Fit_Customer1To1Adapter(ArrayList<Fit_Customer1To1Item> customer1To1Items, LayoutInflater inflater) {
