package com.smartneck.fit.Fit.Review;
...
public class Fit_ReviewAdapter extends BaseAdapter {
    ArrayList<Fit_ReviewItem> reviewItems;
    LayoutInflater inflater;
    Holder holder;
    public Fit_ReviewAdapter(ArrayList<Fit_ReviewItem> reviewItems, LayoutInflater inflater) {
