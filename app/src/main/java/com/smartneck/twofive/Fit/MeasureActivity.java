...
import static com.smartneck.twofive.Fit.Main.MainActivity.isWeiProgress;
...
import static com.smartneck.twofive.Fit.util.Constants.POUND;
...
public class MeasureActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_seat.setText(Integer.toString(Preset.seat));
            ...
            public void onClick(View v) {
                ...
                if (Preset.seat > 0) {
                    ...
                    if (protocolType.equals("3a")){
                        ((MainActivity) MainActivity.mContext).setMessage(StringUtils.getCommand("44 3A 03 01 02"));
        ...
        btn_weight_up.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (protocolType.equals("3a")){
                    ...
                    setMessage(new Commend().sendWeightMove((byte)(currentWeight * 10)));
                }
...
//            }
        ...
        btn_prev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (CFG_SEQ == 2 && Constants.deviceType.equals("HOM")){
                    finish();
                    return;
                }
            ...
            case 2:
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (protocolType.equals("3a")){
                            ((MainActivity) MainActivity.mContext).setMessage(StringUtils.getCommand("44 3A 07 00 03 " + StringUtils.getHexStringCode(Preset.seat) + " 00 00 00 00 00 00 00 00 00 00 00 00 00"));
...
//                        }
                        ...
                        if (protocolType.equals("3a")){
                            ...
                            if (deviceType.equals("HOM")){
                                CFG_HEIGHT[1] = Preset.getHomeHeightValue(Integer.parseInt(CFG_RECEIVED[8], 16), Integer.parseInt(CFG_RECEIVED[5], 16));
                            }else{
    ...
    private void updateMeasure() {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                param.add("memberNo", User.MemberNo);
                param.add("token", User.token);
                param.add("maxWeight", Preset.MaxWeight);
                param.add("maxHeight", Preset.MaxHeight);
                param.add("seat", Preset.seat);
                param.add("setup", Preset.setup);
                param.add("productNo", Preset.DEVICE_NAME);
                Preset.measureSetup = Preset.setup;
                Address address = new Address();
                HttpConnect httpConnect = new HttpConnect();
