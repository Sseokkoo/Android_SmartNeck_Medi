                        ...
                        public void run() {
                            ...
                            if (type.equals("password")) {
                                if (httpConnect.getReceiveMessage().equals(Constants.FAIL)){
                                    Toast.makeText(com.smartneck.twofive.Fit.FindPasswordActivity.this, getString(R.string.toast_enter_check), Toast.LENGTH_SHORT).show();
                                }else{
                                ...
                                if (httpConnect.getReceiveMessage().equals(Constants.FAIL)) {
                                    ...
                                    Toast.makeText(com.smartneck.twofive.Fit.FindPasswordActivity.this, getString(R.string.send_to_mail), Toast.LENGTH_SHORT).show();
                                    finish();
