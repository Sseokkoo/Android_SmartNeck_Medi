...
public class BreakTimeDialog {
    Context context;
    LayoutInflater layoutInflater;
    Handler handler;
    MediaPlayer mediaPlayer;
    public BreakTimeDialog(Context context , LayoutInflater layoutInflater , MediaPlayer mediaPlayer) {
    ...
    public void showBreakTimeDialog() {
        preset.setBreakTime(true);
        String title = context.getString(R.string.title_break_time);
        ...
        tv_timeCount.setText(String.valueOf(preset.getBreakTime()));
        tv_title.setText(title);

        dialog.setOnDismissListener(new DialogInterface.OnDismissListener() {
            @Override
            public void onDismiss(DialogInterface dialog) {
                preset.setBreakTime(false);
                mediaPlayer.stop();
            }
        });
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                String message_en_2 = " second.";
                        ...
                        for (int i = preset.getBreakTime(); 0 <= i; i--){
